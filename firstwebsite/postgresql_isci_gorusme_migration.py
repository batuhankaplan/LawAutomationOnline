"""
PostgreSQL için işçi görüşme tutanağı PDF path migration scripti
...
def migrate_postgresql_isci_gorusme_pdf_path():
    ...
    try:
        ...
        cursor.execute("""
            ...
            WHERE table_name = 'isci_gorusme_tutanagi'
        """)
...
if __name__ == '__main__':
    migrate_postgresql_isci_gorusme_pdf_path()
